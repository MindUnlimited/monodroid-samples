...
namespace MindSet
{
    ...
    public class GroupsActivity : AppCompatActivity, NavigationView.IOnNavigationItemSelectedListener
    {
        ...
        protected async override void OnCreate(Bundle savedInstanceState)
        {
            ...
            recyclerView = FindViewById<RecyclerView>(Resource.Id.recyclerview_groups);
            ...
            setupRecyclerView(recyclerView, groups);
        }

        protected void setupRecyclerView(RecyclerView recyclerView, List<Group> groups)
        {
            ...
            groupsRecyclerViewAdapter = new GroupsRecyclerViewAdapter(this, groups);
    ...
    public class GroupsRecyclerViewAdapter : RecyclerView.Adapter
    {
        ...
        public GroupsRecyclerViewAdapter(Android.App.Activity context, List<Todo.Group> groups)
        {
            parent = context;
